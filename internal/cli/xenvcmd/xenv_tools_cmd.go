...
// XEnvToolsCmd the xenv tools command implementation
var XEnvToolsCmd = &gcli.Command{
	Name:    "tools",
	Aliases: []string{"t", "tool"},
	Desc:   "Manage development tools (install, list, etc.)",
	Subs: []*gcli.Command{
		// Add subcommands that will use actual implementation
		ToolsInstallCmd(),
		ToolsUninstallCmd(),
		ToolsUpdateCmd(),
		ToolsShowCmd(),
